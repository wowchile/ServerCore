...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        void SendMessageToSetInRange(WorldPacket* data, float dist, bool self, bool includeMargin = false, bool ownFaction = false); // pussywizard!
        ...
        void SendMessageToSet(WorldPacket* data, Player const* skipped_rcvr) { SendMessageToSetInRange(data, GetVisibilityRange(), skipped_rcvr != this, true); } // pussywizard!
